...
public class RangeSet {
	...
	/**
	 * Tells if there is at least one interval that intersects with [x,y]. It modifies attributes of p in case of an intersection. 
	 * A point is used as a quick hack to communicate two integers and being able to return modified values in a boolean method.
	 * @param c describes interval [x, y], its entries are modified to represent the intersection if there is one
	 * @return true if there is an intersection, false otherwise
	 */
	public boolean intersect(Cells c) {
