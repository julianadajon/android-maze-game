...
//	}
	...
	public void storeSeg(Document doc, Element mazeXML, int number, int i) {
		...
		int c = col[0] + col[1] + col[2];

//		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, Integer.parseInt(string(col))) ;
		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, c) ;

	}

	
	private String string(int[] col){
	...
	public boolean equals(Object other){
		...
		if ((x != o.x) || (dx != o.dx) ||(y != o.y) || (dy != o.dy)) 
			return false ; 
		if ((dist != o.dist) || (partition != o.partition) ||(seen != o.seen) || (Integer.parseInt(string(col)) != Integer.parseInt(string(o.col)))) 
			return false ;
