...
import edu.wm.cs.cs301.julianadajon.generation.BSPBranch;
import edu.wm.cs.cs301.julianadajon.generation.BSPLeaf;
import edu.wm.cs.cs301.julianadajon.generation.BSPNode;
import edu.wm.cs.cs301.julianadajon.generation.CardinalDirection;
import edu.wm.cs.cs301.julianadajon.generation.Cells;
import edu.wm.cs.cs301.julianadajon.generation.MazeBuilder;
import edu.wm.cs.cs301.julianadajon.generation.Seg;
...
//			return ;
	...
	private void drawBackground(MazePanel mp) {
		System.out.println("entered drawBackground(mp) in FirstPersonRedraw");

		mp.drawBkg("black", view_width, view_height);
		mp.drawBkg("darkGray", view_width, view_height);
	...
	private boolean boundingBoxIsVisible(BSPNode b) {
		...
		//use cells object to keep track of x and y coordinates
		Cells c = new Cells(true, x1, x2);
		return (rset.intersect(c));
	}
