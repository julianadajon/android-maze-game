...
import edu.wm.cs.cs301.julianadajon.falstad.Sensors;
...
public class BasicRobot implements Robot {
	...
	public void setMaze(MazeController maze) {
		System.out.println("set maze in brobot" + mazeController == null);
		mazeController = maze; 
	}

	private void initSensors() {
		System.out.println(mazeController == null);
